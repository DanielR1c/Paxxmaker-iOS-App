...
// ─── Router ───────────────────────────────────────────────────────────────────
// Localized push titles. Falls back to English for unknown languages — the app
// mirrors its chosen language into the "locale:<secret>" KV entry.
const PUSH_TITLES: Record<string, Record<string, string>> = {
  complete: {
    en: "Print done ✓", de: "Druck fertig ✓", fr: "Impression terminée ✓",
    es: "Impresión lista ✓", pt: "Impressão concluída ✓", it: "Stampa completata ✓",
    zh: "打印完成 ✓",
  },
  error: {
    en: "Print error", de: "Druckfehler", fr: "Erreur d'impression",
    es: "Error de impresión", pt: "Erro de impressão", it: "Errore di stampa",
    zh: "打印错误",
  },
  cancelled: {
    en: "Print cancelled", de: "Druck abgebrochen", fr: "Impression annulée",
